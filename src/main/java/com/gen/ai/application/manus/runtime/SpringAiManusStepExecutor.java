 ...
 *       结束外层 Manus（避免「任务已完成」仍跑满 {@code maxSteps}）。</li>
 *   <li>若仍请求工具，则继续外层步，直至达到 {@link ManusRunRequest#maxSteps()}。</li>
...
public final class SpringAiManusStepExecutor implements ManusStepExecutor {
    ...
    /**
     * 写入 {@link com.gen.ai.application.manus.api.ManusStepEvent} / {@link com.gen.ai.application.manus.api.ManusRunResult}
