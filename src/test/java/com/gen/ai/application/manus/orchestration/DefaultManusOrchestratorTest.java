...
class DefaultManusOrchestratorTest {
    ...
    void finishesEarlyWhenExecutorDeclaresDone() {
        ...
        DefaultManusOrchestrator orchestrator =
                new DefaultManusOrchestrator(
                        new PlaceholderManusBrainResolver(), executor, sink, new FirstStepOnlyRagPolicy());
    ...
    void hitsMaxStepsWhenExecutorNeverFinishes() {
        ...
        DefaultManusOrchestrator orchestrator =
                new DefaultManusOrchestrator(
                        new PlaceholderManusBrainResolver(), executor, events::add, new FirstStepOnlyRagPolicy());
    ...
    void brainResolverResolveCalledExactlyOnce() {
        ...
        DefaultManusOrchestrator orchestrator =
                new DefaultManusOrchestrator(counting, executor, e -> {}, new FirstStepOnlyRagPolicy());
